...
# mistral sentiment, gaussian target distribution.
#   -> benchmark/pure_alpha/mistral/gaussian/
#
# Pairs with the baseline in scripts/portfolio/gaussian/mistral.sh and the I-MACD
# arm in scripts/portfolio/imacd/gaussian/mistral.sh. All arms train the same
...
#   ./scripts/portfolio/macro_alpha/pure_alpha/gaussian/mistral.sh --holdings 40 60
