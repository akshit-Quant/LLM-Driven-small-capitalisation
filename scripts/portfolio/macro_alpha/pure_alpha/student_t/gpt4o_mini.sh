...
# gpt4o_mini sentiment, student_t target distribution.
#   -> benchmark/pure_alpha/gpt4o_mini/student_t/
#
# Pairs with the baseline in scripts/portfolio/student_t/gpt4o_mini.sh and the I-MACD
# arm in scripts/portfolio/imacd/student_t/gpt4o_mini.sh. All arms train the same
...
#   ./scripts/portfolio/macro_alpha/pure_alpha/student_t/gpt4o_mini.sh --holdings 40 60
