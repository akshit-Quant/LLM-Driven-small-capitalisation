...
# llama2 sentiment, student_t target distribution.
#   -> benchmark/pure_alpha/llama2/student_t/
#
# Pairs with the baseline in scripts/portfolio/student_t/llama2.sh and the I-MACD
# arm in scripts/portfolio/imacd/student_t/llama2.sh. All arms train the same
...
#   ./scripts/portfolio/macro_alpha/pure_alpha/student_t/llama2.sh --holdings 40 60
