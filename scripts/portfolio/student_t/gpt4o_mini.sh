#!/usr/bin/env bash
#
# Portfolio run on Azure OpenAI gpt-4o-mini sentiment, Student-t target distribution.
#   -> benchmark/universal/gpt4o_mini/student_t/
#
# Needs ./scripts/news/gpt4o_mini.sh to have run first.
# Extra args override the defaults, e.g.
#   ./scripts/portfolio/student_t/gpt4o_mini.sh --holdings 5 20
