#!/usr/bin/env bash
#
# I-MACD arm: portfolio run on Llama-2-13B-chat sentiment, Gaussian target distribution,
# with threshold-based I-MACD alpha filtering.
#   -> benchmark_imacd/llama2_13b_chat/gaussian/
#
# Pairs with the baseline run in scripts/portfolio/gaussian/llama2.sh, which is
...
#   ./scripts/portfolio/imacd/gaussian/llama2.sh --holdings 40 60
