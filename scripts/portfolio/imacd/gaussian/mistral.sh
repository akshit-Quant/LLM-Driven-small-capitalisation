#!/usr/bin/env bash
#
# I-MACD arm: portfolio run on Mistral-7B-Instruct sentiment, Gaussian target distribution,
# with threshold-based I-MACD alpha filtering.
#   -> benchmark_imacd/mistral_7b_instruct/gaussian/
#
# Pairs with the baseline run in scripts/portfolio/gaussian/mistral.sh, which is
...
#   ./scripts/portfolio/imacd/gaussian/mistral.sh --holdings 40 60
