#!/usr/bin/env bash
#
# I-MACD arm: portfolio run on FinBERT sentiment, Gaussian target distribution,
# with threshold-based I-MACD alpha filtering.
#   -> benchmark_imacd/finbert/gaussian/
#
# Pairs with the baseline run in scripts/portfolio/gaussian/finbert.sh, which is
...
#   ./scripts/portfolio/imacd/gaussian/finbert.sh --holdings 40 60
