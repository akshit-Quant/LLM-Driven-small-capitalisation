#!/usr/bin/env bash
#
# I-MACD arm: portfolio run on FinBERT sentiment, Student-t target distribution,
# with threshold-based I-MACD alpha filtering.
#   -> benchmark_imacd/finbert/student_t/
#
# Pairs with the baseline run in scripts/portfolio/student_t/finbert.sh, which is
...
#   ./scripts/portfolio/imacd/student_t/finbert.sh --holdings 40 60
