#!/usr/bin/env bash
#
# I-MACD arm: portfolio run on Azure OpenAI gpt-4o-mini sentiment, Student-t target distribution,
# with threshold-based I-MACD alpha filtering.
#   -> benchmark_imacd/gpt4o_mini/student_t/
#
# Pairs with the baseline run in scripts/portfolio/student_t/gpt4o_mini.sh, which is
...
#   ./scripts/portfolio/imacd/student_t/gpt4o_mini.sh --holdings 40 60
