#!/usr/bin/env bash
#
# I-MACD arm: portfolio run on Llama-2-13B-chat sentiment, Student-t target distribution,
# with threshold-based I-MACD alpha filtering.
#   -> benchmark_imacd/llama2_13b_chat/student_t/
#
# Pairs with the baseline run in scripts/portfolio/student_t/llama2.sh, which is
...
#   ./scripts/portfolio/imacd/student_t/llama2.sh --holdings 40 60
